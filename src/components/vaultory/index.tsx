...
import "../../index.css";
import "../vaultory/vaultory-responsive.css"; // Import updated responsive styles
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-6 sm:mb-8">
          ...
          {/* Multi-Currency Card */}
          <div className="w-full max-w-[555px] h-[250px] sm:h-[300px] lg:h-[350px] rounded-[10px] px-4 border border-gray-700 flex items-center justify-between mx-auto lg:mx-0 vaultory-card vaultory-multi-currency-card">
            <div
              className="mt-20 sm:mt-32 lg:mt-40 flex-shrink-0 vaultory-card-content"
        ...
        {/* Cards Section */}
        <div
          className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-7 transition-all duration-1000 vaultory-card-grid ${
        ...
        >
          {[teamCards, reconciliation, reporting].map((img, index) => (
            <a href="#" key={index} className="block">
              <div
                className="bg-no-repeat bg-cover bg-center border border-gray-700 backdrop-blur-sm p-4 sm:p-6 relative w-full h-[280px] sm:h-[310px] lg:h-[330px] max-w-[386px] mx-auto sm:mx-0 vaultory-card"
                style={{
                  borderRadius: "10px",
              ...
              >
                <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 vaultory-card-content">
                  <h3
                    className="capitalize font-haffer text-lg sm:text-xl lg:text-[25px]"
                    style={{
                      fontWeight: 670,
